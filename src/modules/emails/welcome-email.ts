...
export async function sendWelcomeEmail(data: WelcomeEmailData): Promise<void> {
  try {
    const html = `
      <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; font-family: 'Inter', sans-serif;">
        <div style="background: linear-gradient(135deg, #FF4D8D, #FF80AC); padding: 48px 32px; text-align: center;">
          <h1 style="margin: 0; color: #ffffff; font-size: 32px; font-weight: 800; letter-spacing: -0.5px;">Welcome to Lizzy's Beauty Studio ✨</h1>
        ...
        <div style="padding: 40px 32px;">
          ...
          <p style="font-size: 15px; color: #6b7280; margin: 0 0 32px; line-height: 1.6;">
            Welcome to the Lizzy's Beauty Studio family! We're thrilled to have you. Your account has been successfully created and you're all set to explore our premium collection.
          </p>
          ...
          <p style="font-size: 13px; color: #9ca3af; text-align: center; margin: 32px 0 0;">
            ...
            Lizzy's Beauty Studio — Premium Hair & Beauty
          </p>
        </div>
      </div>
    `;
    ...
    await sendEmail({
      to: data.email,
      subject: "Welcome to Lizzy's Beauty Studio ✨ — Your account is ready!",
      html,
    });
