          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50/50">
                ...
                <th className="px-6 py-5 text-left text-xs font-black text-gray-400 uppercase tracking-widest">Price / Duration</th>
              ...
              {services.map((service) => (
                <tr key={service.id} className="hover:bg-gray-50/50 transition group">
                  ...
                  <td className="px-6 py-6 whitespace-nowrap">
                    <div className="text-sm font-bold text-gray-900">${Number(service.fullPrice || 0).toFixed(2)}</div>
                    <div className="text-[11px] font-bold text-gray-400 mt-0.5">{service.depositPercentage}% Dep. • {service.duration}m</div>
                  </td>
                  <td className="px-6 py-6 whitespace-nowrap">
                    {service.isActive ? (
          ...
          <div key={service.id} className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm space-y-5">
            ...
            <div className="flex items-center gap-4 px-1">
              <div className="text-sm">
                <span className="font-bold text-gray-900">${Number(service.fullPrice || 0).toFixed(2)}</span>
                <span className="text-[11px] font-bold text-gray-400 ml-1 uppercase tracking-wider">({service.depositPercentage}% dep)</span>
              </div>
              <div className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">{service.duration} mins</div>
            </div>
