    ...
    try {
      ...
      if (result?.error) {
        ...
        toast.success("Welcome back", {
          description: "Authenticated as Lizzy's Studio Administrator"
        });
        router.push("/admin");
      }
    } catch (error) {
      ...
      <div className="w-full max-w-[480px] z-10">
        <div className="text-center mb-10 space-y-3">
          ...
          <h1 className="text-4xl font-black text-white tracking-tighter uppercase">
            Lizzy&apos;s <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF4D8D] to-pink-400">Studio</span>
          </h1>
        ...
        <div className="mt-10 flex flex-col items-center gap-6">
          ...
          <p className="text-[10px] font-bold text-gray-600 text-center uppercase tracking-widest">
            © 2026 Lizzy&apos;s Beauty Studio Internal Systems
          </p>
        </div>
      </div>
    </div>
