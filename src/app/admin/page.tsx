...
export default async function AdminDashboardPage() {
  ...
  const totalRevenue = revenueData._sum.depositPaid ? Number(revenueData._sum.depositPaid) : 0;
  ...
  const stats = [
    ...
    { label: "Total Deposit Revenue", value: formatPrice(totalRevenue, currency), icon: Coins, color: "text-emerald-600", bg: "bg-emerald-50" },
    ...
    <div className="space-y-10 max-w-[1600px] mx-auto pb-10">
      ...
      <div className="bg-gradient-to-r from-pink-100 to-pink-50 rounded-[2rem] p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between shadow-sm border border-pink-100 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <h1 className="text-2xl md:text-3xl font-black text-[#FF4D8D] mb-1 tracking-tight">Booking Studio Admin</h1>
