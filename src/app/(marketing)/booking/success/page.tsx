...
export const metadata: Metadata = {
  title: "Booking Success | Lizzy's Beauty Studio",
  ...
  return (
    <div className="bg-white min-h-screen flex items-center justify-center">
      <div className="mx-auto max-w-md px-4 text-center">
        ...
        <h1 className="font-outfit text-3xl font-black tracking-tight text-gray-900 sm:text-4xl mb-4">
          Booking Confirmed!
        </h1>
        <p className="font-inter text-gray-500 text-lg mb-10">
          Thank you for choosing Lizzy's Beauty Studio. We have received your deposit and your appointment is confirmed. A confirmation email has been sent to you.
        </p>
