        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-black focus:ring-black sm:text-sm py-2 px-3 border min-w-0"
            />
            {errors.fullPrice && <p className="mt-1 text-sm text-red-600">{errors.fullPrice.message}</p>}
          </div>
          ...
          <div className="min-w-0">
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-black focus:ring-black sm:text-sm py-2 px-3 border min-w-0"
            />
            {errors.depositPercentage && <p className="mt-1 text-sm text-red-600">{errors.depositPercentage.message}</p>}
          </div>
        </div>
