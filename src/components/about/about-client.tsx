      ...
      <section className="relative w-full min-h-[55vh] md:min-h-[30vh] flex items-center justify-center pt-24 pb-16 md:pt-28">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Lizzy's Beauty Studio Interior"
            fill
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left">
          <FadeInSection>
            ...
            <p className="text-lg md:text-xl text-gray-200 font-medium mb-10 max-w-2xl mx-auto md:mx-0">
              Lizzy's Beauty Studio is your ultimate destination for premium hair products and professional beauty services. Elevate your everyday look with uncompromised quality.
            </p>
            <Link
              href="/products"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <FadeInSection delay={100} className="lg:order-1">
            ...
            <div className="space-y-5 text-gray-600 font-medium text-lg leading-relaxed">
              <p>
                Born from a deep passion for authentic beauty, Lizzy's Beauty Studio was established to bridge the gap between luxury quality and accessible elegance. We believe that premium hair isn't just an accessory, it's the crown you never take off.
              </p>
              <p>
              ...
              <p>
                Beyond products, Lizzy's Beauty Studio is a sanctuary for transformation. Our expert stylists combine artistry with precision to deliver a beauty experience that leaves you looking—and feeling, absolute perfection.
              </p>
            </div>
          </FadeInSection>
          ...
          <FadeInSection delay={300} className="lg:order-2">
            <div className="relative aspect-square lg:aspect-[4/3] w-full rounded-3xl overflow-hidden shadow-2xl group">
              <Image
                ...
                alt="Lizzy's Beauty Studio Story"
                fill
