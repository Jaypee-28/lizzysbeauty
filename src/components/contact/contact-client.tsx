    ...
    <div className="w-full overflow-hidden bg-white">
      ...
      <section className="relative z-20 -mt-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {[
            { icon: Phone, label: "Call Us", value: "+44 20 1234 5678", href: "tel:+442012345678" },
            { icon: Mail, label: "Email Us", value: "hello@lizzysbeautystudio.com", href: "mailto:hello@lizzysbeautystudio.com" },
            { icon: MapPin, label: "Visit Us", value: "23 Luxury Ave, UK", href: "#" },
      ...
      <section className="py-16 md:py-24 bg-gray-50/50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 text-center">
            <Link href="/faqs" className="text-[#FF4D8D] font-bold hover:underline inline-flex items-center gap-2">
              View All FAQs
            </Link>
          </div>
        </div>
